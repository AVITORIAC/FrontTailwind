...
function Auto_avaliacao() { //FUNÇÃO DA TELA DE AUTO AVALIAÇÃO DO ACESSO DE APRENDIZ
    ...
    return (
        <div className={`flex flex-col h-full gap-4 mt-10 mx-10`}>
            ...
            <p className={`text-base font-roboto`}>Bem-vindo(a) a sua auto avaliação, leia cada critério atentamente e reflita sobre sua nota antes de submeter suas respostas. Abaixo você encontra a descrição de cada nota e  de cada critério. Além disso, todos os campos obrigatórios devem ser preenchidos.</p>
