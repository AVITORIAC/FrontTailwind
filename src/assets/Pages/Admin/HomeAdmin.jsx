  ...
  return (
    <div className={`flex flex-col w-full h-fit gap-20`}>
      <div className={`mx-auto mt-4 w-full flex justify-evenly`}>
        ...
        <Link to='/Cadastro_turma'> <Card azul3 h1='Administrador' h2='Email ' p='Edite os dados de usuário que envia o e-mail.' /></Link>
      </div>
      <div className={`mx-auto w-11/12 flex justify-evenly`}>
        ...
        <Link to='/Cadastro_aprendiz'><Card azul1 h1='Administrador' h2='Notas do Senai' p='Adicione as notas do SENAI dos aprendizes através do Excel.' /></Link>
      </div>
    </div>
  )
}
