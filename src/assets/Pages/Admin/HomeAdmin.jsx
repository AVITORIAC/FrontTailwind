...
function HomeAdmin() { //TELA INICIAL DO ACESSO DE ADMINISTRADOR
  ...
  return (
    <div className={`flex flex-col w-full h-fit gap-20 sm:gap-5  md:gap-5 xl:h-full`}>
      ...
      <div className={`mx-auto w-full flex justify-evenly sm:flex-col sm:items-center sm:gap-4 md:flex-col md:items-center md:gap-4 xl:flex-row`}>
