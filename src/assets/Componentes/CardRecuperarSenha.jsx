...
function CardRecuperarSenha() { //CARD PARA TELA DO CODIGO DE RECUPERAÇÃO DE SENHA 
    ...
    return (
        <div className={'bg-white relative mt-20 w-7/12 h-screenP 3xl:w-5/12 3xl:h-screen6'}>
            ...
            <div className={'flex flex-col items-center'}>
                ...
                <div className={'flex flex-col gap-5 mt-5 items-center'}>
                    <h2 className={'font-semibold sm:ml-2'}>Digite abaixo o código enviado no seu email: allana123@gmail.com <br/> para recuperar sua senha. Caso o código não esteja na sua caixa de entrada, verifique o spam.</h2>
